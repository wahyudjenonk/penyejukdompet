...
class Oauthclient {
	...
	function setService($service) {
		switch($service) {
			...
			case "dapodik":
				$this->_oAuthRequestTokenUrl 	= "http://data.dikdasmen.kemdikbud.go.id/sso/token";
				$this->_oAuthAuthorizeUrl		= "http://data.dikdasmen.kemdikbud.go.id/sso/auth";
				$this->_oAuthAccessTokenUrl		= "http://data.dikdasmen.kemdikbud.go.id/sso/token";
				$this->_oAuthRedirectUrl		= "http://www.aldeaz.id/katalog";

				$this->_callMyProfile			= "http://data.dikdasmen.kemdikbud.go.id/sso/profile";
				$this->_responseFormat			= "json";
				break;
